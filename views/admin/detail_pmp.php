      ...
      <?php foreach  ($detail as $dt):?>
      	<div class="card">
              ...
              <div col-md-6>
                ...
                <a class="btn btn-lg btn-danger ml-2" href="<?php echo base_url ('admin/berkas_pmp')?>">KEMBALI</a>
                <a class="btn btn-lg btn-primary ml-2" href="<?php echo base_url ('admin/berkas_pmp/edit_berkas/'.
                $dt->id_pmp)?>">UPDATE</a>
