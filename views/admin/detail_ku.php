<div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Detail Data Berkas KEUANGAN</h1>
          </div>
      </section>
      ...
      <?php foreach  ($detail as $dt):?>
      	<div class="card">
              ...
              <div col-md-6>
                ...
                <a class="btn btn-lg btn-danger ml-2" href="<?php echo base_url ('admin/berkas_ku')?>">KEMBALI</a>
                <a class="btn btn-lg btn-primary ml-2" href="<?php echo base_url ('admin/berkas_ku/edit_berkas/'.
                $dt->id_keuangan)?>">UPDATE</a>
