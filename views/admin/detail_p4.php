      ...
      <?php foreach  ($detail as $dt):?>
      	<div class="card">
              ...
              <div col-md-6>
                ...
                <a class="btn btn-lg btn-danger ml-2" href="<?php echo base_url ('admin/berkas_p4')?>">KEMBALI</a>
                <a class="btn btn-lg btn-primary ml-2" href="<?php echo base_url ('admin/berkas_p4/edit_berkas/'.
                $dt->id_p4)?>">UPDATE</a>
