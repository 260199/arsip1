      ...
      <?php foreach  ($detail as $dt):?>
      	<div class="card">
              ...
              <div col-md-6>
                ...
                <a class="btn btn-lg btn-danger ml-2" href="<?php echo base_url ('admin/berkas_kpp')?>">KEMBALI</a>
                <a class="btn btn-lg btn-primary ml-2" href="<?php echo base_url ('admin/berkas_kpp/edit_berkas/'.
                $dt->id_kpp)?>">UPDATE</a>
